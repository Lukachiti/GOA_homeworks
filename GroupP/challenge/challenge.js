...
window.onload = function () {
    ...
    const message = "Welcome! Here, you can challenge yourself to do your tasks as fast as possible.";
    let i = 0;
    ...
    nextGreet.onclick = function () {
        ...
        const message2 = "Set a time limit for each item on your to-do list and race against the clock!";
        let i = 0;
